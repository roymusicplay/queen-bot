...
PM_START_TEXT = """
ʜᴇʟʟᴏ [🤗](https://telegra.ph/file/0a1b7c718c6301f85b3a4.jpg), ɪᴍ queen ᴀ ʜɪɢʜʏ ᴀᴅᴠᴀɴᴄᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ʟᴏᴛꜱ ᴏꜰ ᴀᴍᴀᴢɪɴɢ ᴛᴏᴏʟꜱ.
...
buttons = [
    ...
    [   
       InlineKeyboardButton(text="𝙑𝘾 𝙋𝙇𝘼𝙔𝙍𝙀" , url="t.me/ABHINAS_ROY52"),
    ],
    [
...
HELP_STRINGS = """
`ʜɪ.. ɪ'ᴍ` queen [🙋‍♀️](https://telegra.ph/file/0a1b7c718c6301f85b3a4.jpg)
`ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴꜱ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ᴅᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ꜱᴘᴇᴄɪꜰɪᴄ ᴍᴏᴅᴜʟᴇꜱ..`"""

amelia_IMG = "https://telegra.ph/file/0a1b7c718c6301f85b3a4.jpg"
...
def amelia_about_callback(update, context):
    ...
    if query.data == "amelia_":
        query.message.edit_text(
            text=""" ℹ️ I'm *queen*, a powerful group management bot built to help you manage your group easily.
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *queen*
                 \nHere is the [𝙁𝘼𝙏𝙃𝙀𝙍](https://t.me/abhinasroy) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
